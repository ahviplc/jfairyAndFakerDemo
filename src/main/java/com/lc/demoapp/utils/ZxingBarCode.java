...
public class ZxingBarCode {
	...
	public static void main(String[] args) throws Exception {
		...
		ZxingBarCode.encode(checksum("695", "32321", "2133"), "D:\\zxing_Target_ZxingBarCode.PNG", 500, 50,20);
		System.out.println("解析结果:"+ZxingBarCode.decode("D:\\zxing_Target_ZxingBarCode.PNG"));
	}
}
