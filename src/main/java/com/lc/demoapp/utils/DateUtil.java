...
public final class DateUtil {
    ...
    public static void main(String args[]){
        System.out.println(convert(new Date(),DEFAULT_TIMESTAMP));//yyyyMMddHHmmss-20181010112832 //20190605153847
        System.out.println(convert("20181010112832",DEFAULT_TIMESTAMP));//Wed Oct 10 11:28:32 CST 2018

		System.out.println(convert(currentTimestamp(), DEFAULT_TIMESTAMP)); //20190605152459
		System.out.println(convert(currentTimestamp(), DATETIME_FORMAT));//2019-06-05 15:26:16
		System.out.println(convert("2019-06-05 15:26:16",DATETIME_FORMAT));//Wed Jun 05 15:26:16 CST 2019
		System.out.println(currentTimestamp());//2019-06-05 15:29:16.882
		System.out.println(getTimeMillis("2019-06-05 15:26:16"));//1559719576000

		Long lll = Long.parseLong("1559719576000");
		System.out.println(convert(lll, DATETIME_FORMAT));//2019-06-05 15:26:16


		Long lll2 = Long.parseLong("1559719009034");
		System.out.println(convert(lll2, DATETIME_FORMAT));//2019-06-05 15:16:49
    }
}
